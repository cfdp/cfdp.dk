...
<script type="text/javascript">
	...
	<div class="projects content grid_12 clearfix zi1">
		...
		{
			echo '<div class="grid_12 alpha clearfix">
			...
			echo '<div class="childCatPosts grid_8 alpha clearfix">';
		    ...
		    if ( have_posts() ) : $count = 0;
					...
					<div class="childCatPosts grid_8 alpha clearfix">
		...
		<div class="grid_4 omega clearfix"> <?php the_post_thumbnail(); the_content(); ?></div>
	</div>
