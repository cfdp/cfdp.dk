<?php
/*
Template Name: Erfarninger
*/
?>
<?php get_header(); ?>

	<div class="experience content grid_12 clearfix zi1">
		<?php

		// Erfarninger category = ID 8
		$categories=get_categories('child_of=8&orderby=slug');
		...
		// array of child cat to cat ID 8 in a foreach
		foreach($categories as $category)
		{
			if($category->category_description!='menu'){
				echo '<div class="category-wrap '.($category->slug).' grid_12 alpha"><div class="grid_12 alpha clearfix">
							...
							<h2 class="description">Erfaringer med '.($category->name).'</h2>
						</div>
