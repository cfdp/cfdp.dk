		...
		<table style="padding:0">
			<tr>
				...
				<td style="border:0; padding:0">
					<?php echo number_format( $pageviews );
					_e( 'pageviews', 'google-analytics-dashboard' ); ?><br />
					<?php echo number_format( $exits );
					_e( 'exits', 'google-analytics-dashboard' ); ?><br />
					<?php echo number_format( $uniques );
					_e( 'uniques', 'google-analytics-dashboard' ); ?><br />
				</td>
			</tr>
		</table>
	<?php
