...
return array(
	'features' => array(
		array('auto_link_tags', __('Auto links tags', 'simpletags'), 'checkbox', '1',
		...
		array('use_click_tags', __('Click tags feature', 'simpletags'), 'checkbox', '1',
		...
		array('use_autocompletion', __('Autocompletion with old input', 'simpletags'), 'checkbox', '1',
		...
		array('use_suggested_tags', __('Suggested tags feature', 'simpletags'), 'checkbox', '1',
		...
		array('active_related_posts', __('Related posts by terms', 'simpletags'), 'checkbox', '1',
