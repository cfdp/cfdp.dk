...
if ( ! class_exists( 'PS_Settings' ) ) :
	...
	class PS_Settings {
		...
		public function plugin_page() {
			...
			$logo = PASSSTER_URL . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'admin' . DIRECTORY_SEPARATOR . 'passster-logo.png';

			echo '<div class="wrap passster-admin">';
			echo '<div class="passter-logo" style="background-image:url(' . $logo . ');background-size: contain;background-repeat: no-repeat;"></div>';
